    ...
    ?>  
        <div class="footer-b">
            ...
            <div class="site-info">
                ...
                <a href="<?php echo esc_url( 'http://raratheme.com/wordpress-themes/wedding-band/' ); ?>" rel="author" target="_blank"><?php echo esc_html__( 'Wedding Band by Rara Theme.', 'wedding-band' ); ?></a>
